...
{
public:
    Caballero(std::string nombre = "Caballero", TipoPieza tipo = TipoPieza::CABALLERO, Bando b = Bando::LUZ, const ContenedorSprites& contenedorSprites = ContenedorSprites());
